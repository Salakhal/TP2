...
public class Ensenble_Exercices {

    // Exercice 1 — Sous_suite maximale croissante
    public static void sousSuiteMaximale() {
        Scanner sc = new Scanner(System.in);
        System.out.println("Veillez entrez les elements du tableau séparés par un espace :");
        ...
        int maxLen = 0;
        for (int len : dp) if (len > maxLen) maxLen = len;
    ...
    public static void tableauPivot() {
        ...
        for (int i = 0; i < n; i++) {
            if (maxGauche[i] <= t[i] && t[i] <= minDroite[i]) System.out.print(t[i] + " ");
        }
        System.out.println();
    }
    ...
    public static void matriceSpirale() {
        Scanner sc = new Scanner(System.in);
        System.out.print("Veillez entrez la taille n de la matrice : ");
        int n = sc.nextInt();
        int[][] mat = new int[n][n];
        int num = 1;
    ...
    public static void permutationCirculaire() {
        ...
        int n = sc.nextInt();
        int[] t = new int[n];
        System.out.println("Veillez entrez les elements :");
    ...
    public static void sousTableauMax() {
        Scanner sc = new Scanner(System.in);
        System.out.println("Veillez entrez les elements du tableau :");
        String[] input = sc.nextLine().split(" ");
        int n = input.length;
        int[] t = new int[n];
        for (int i = 0; i < n; i++) t[i] = Integer.parseInt(input[i]);
        ...
        System.out.println("Somme maximale d'une sous-suite contigue : " + maxSoFar);
    }

    // Exercice 7 — Fréquence majoritaire
    public static void majorite() {
        Scanner sc = new Scanner(System.in);
        System.out.println(" Viellez entrez les elements du tableau :");
        String[] input = sc.nextLine().split(" ");
        int n = input.length;
        int[] t = new int[n];
        for (int i = 0; i < n; i++) t[i] = Integer.parseInt(input[i]);
    ...
    public static void nombresAbsents() {
        Scanner sc = new Scanner(System.in);
        System.out.println("Veillez entrez les éléments du tableau :");
        String[] input = sc.nextLine().split(" ");
        int n = input.length;
        int[] t = new int[n];
        for (int i = 0; i < n; i++) t[i] = Integer.parseInt(input[i]);
    ...
    public static void sommeDiagonale() {
        ...
        int n = sc.nextInt();
        int[][] mat = new int[n][n];
        System.out.println(" Veillez entrez les éléments de la matrice :");
        for (int i = 0; i < n; i++)
    ...
    public static void matriceMagique() {
        Scanner sc = new Scanner(System.in);
        int[][] mat = new int[3][3];
        System.out.println("Veillez entrez les éléments de la matrice 3x3 :");
        for (int i = 0; i < 3; i++)
    ...
    public static void main(String[] args) {
        Scanner sc = new Scanner(System.in);
        System.out.println("Choisissez un exercice (1-10) : ");
